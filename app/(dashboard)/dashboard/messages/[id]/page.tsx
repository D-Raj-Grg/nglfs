  ...
  return (
    <div className="min-h-screen p-8">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-[#1A1A1A]/80 backdrop-blur-lg rounded-xl p-8 border border-white/10">
          <div className="flex items-start justify-between mb-4">
            <div>
              <h1 className="text-2xl font-bold text-white mb-2">Anonymous Message</h1>
          ...
          <div className="mt-6 p-6 bg-[#0A0A0A]/50 rounded-lg border border-white/5">
          ...
          <div className="mt-6 flex items-center gap-3 pt-6 border-t border-white/10">
            <button
              ...
              disabled={deleting}
              className="inline-flex items-center gap-2 px-4 py-2 bg-red-500/10 hover:bg-red-500/20 text-red-400 rounded-lg transition-colors disabled:opacity-50"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-yellow-500/10 hover:bg-yellow-500/20 text-yellow-400 rounded-lg transition-colors"
            >
            ...
            {!metadata.is_sender_blocked && (
              <button
                onClick={handleBlock}
                className="inline-flex items-center gap-2 px-4 py-2 bg-gray-500/10 hover:bg-gray-500/20 text-gray-400 rounded-lg transition-colors"
              >
            ...
            {metadata.is_sender_blocked && (
              <span className="inline-flex items-center gap-2 px-4 py-2 bg-red-500/10 text-red-400 rounded-lg">
                <Ban className="w-4 h-4" />
                Sender Blocked
              </span>
            )}
        ...
        <div>
          <h2 className="text-xl font-bold text-white mb-4">Sender Analytics</h2>
